...
export class BuiltinModel {
    public readonly constants = {
        ...
        MENUBAR_ITEM_CUT: 'menuBar.item.cut',
        MENUBAR_ITEM_COPY: 'menuBar.item.copy',
        MENUBAR_ITEM_PASTE: 'menuBar.item.paste',
        MENUBAR_ITEM_TOGGLE_LINE_COMMENT: 'menuBar.item.toggleLineComment',
        MENUBAR_ITEM_TOGGLE_BLOCK_COMMENT: 'menuBar.item.toggleBlockComment',
        ...
        MENUBAR_ITEM_GO: 'menuBar.item.go',
        MENUBAR_ITEM_GO_BACK: 'menuBar.item.goBack',
        MENUBAR_ITEM_GO_FORWARD: 'menuBar.item.goForward',
        MENUBAR_ITEM_GO_TO_LAST_EDIT: 'menuBar.item.goToLastEdit',
        MENUBAR_ITEM_GO_TO_FILE: 'menuBar.item.goToFile',
        MENUBAR_ITEM_GO_TO_LINE: 'menuBar.item.goToLine',
    ...
    public readonly modules = {
        ...
        MENUBAR_ITEMS: () =>
            <IMenuItemProps[]>[
                ...
                {
                    id: this.constants.MENUBAR_ITEM_GO,
                    name: this.localize(this.constants.MENUBAR_ITEM_GO, 'Go'),
                    children: [],
                },
                {
